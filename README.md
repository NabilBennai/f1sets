...
This repository contains the **complete product, functional, and technical specifications** required to build a web
application inspired by **F1Laps**.  
It is intentionally **over-documented** so engineering teams can implement features without additional product discovery
or clarification.
